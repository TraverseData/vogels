...
internals.compileModel = function (name, schema, pluralize = true) {

  // extremly simple table names
  var tableName = (pluralize)
    ? name.toLowerCase() + 's'
    : name.toLowerCase();
...
vogels.define = function (modelName, callback, pluralize = true) {
  var schema = new Schema();

  var compiledTable = internals.compileModel(modelName, schema, pluralize);
